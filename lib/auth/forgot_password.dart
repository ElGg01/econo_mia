      ...
      showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: const Text(
                  'An email was sent to your account to reset password'),
              actions: [
                TextButton(
        ...
        const SnackBar(
          content: Row(
            children: [
              ...
              Expanded(
                child: Text('There is no associated account for this email'),
              ),
            ],
          ),
    ...
    return Scaffold(
      appBar: AppBar(
        title: BounceInDown(
          ...
          child: Text(
            text!.appbar_password_forgotten,
